...
const UserScreen = memo(function UserScreen() {
      ...
      >
        ...
        <UserProfile
          user={{
            ...
            avatar: require("../assets/images/level1.png"),
            filterBy,
            handleRarityFilter,
            getRarityIconName,
            theme,
...
const styles = StyleSheet.create({
  ...
  // progressSection: removed (unused)
  // progressText: removed (unused)
  progressBar: {
    height: 10,
  ...
  modalActions: {
    ...
    marginTop: 30,
    justifyContent: "center",
    gap: 20, // removed for compatibility and not standard in RN
  },
  actionButton: {
    alignItems: "center",
    padding: 16,
